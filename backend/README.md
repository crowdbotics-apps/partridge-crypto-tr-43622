...
## Project Structure
    ...
    ├── partridge_crypto_tr_43622  # Django project configurations
...
1. Clone this repo and `cd partridge_crypto_tr_43622`
...
2. Clone this repo and `cd partridge_crypto_tr_43622`
